...
Following DRS (RTSS 2020)~\cite{baruah2020generating}, utilisation vectors are generated via the Dirichlet-Rescale algorithm.
...
\bibitem{baruah2020generating}
Baruah, S. et al.\ ``Generating Utilization Vectors for the Evaluation of Real-Time Scheduling Algorithms.'' \emph{RTSS 2020}.
\end{thebibliography}
